...
typedef struct queue_node_t {
    void              *data; /**< The data stored in the node.
                                  It can be anything. */
    struct queue_node_t *next; /**< Pointer to identify the next node. */
} queue_node_ts;
...
typedef struct queue_t {
    size_t       node_memsize; /**< The size of the data that will be stored
                                    in a node. */
    queue_node_ts *tail; /**< The tail (last node) of the queue. */
    queue_node_ts *head; /**< The head (first node) of the queue. */
} queue_ts;
 ...
 * NULL if it succeded).
 */
queue_ts *create_queue(size_t node_memsize);
 ...
 */
int enqueue(queue_ts *queue, const void *data);
 ...
 * -1 -> the function failed.
 */
int dequeue(queue_ts *queue, void *data);
 ...
 * -1 -> the function failed.
 */
int queue_peek(const queue_ts *queue, void *data);
 ...
 */
void delete_queue(queue_ts *queue);
 ...
 */
int queue_is_empty(const queue_ts *queue);
