...
typedef struct stack_node_t {
    void              *data; /**< The data stored in the node. It can be
                                  anything. */
    struct stack_node_t *prev; /**< Pointer to identify the previous node. */
} stack_node_ts;
...
typedef struct stack_t {
    size_t       node_memsize; /**< The size of the data will be stored in a
                                    node. */
    stack_node_ts *tail; /**< The tail (last node) of the stack. */
} stack_ts;
 ...
 */
stack_ts *create_stack(size_t node_memsize);
 ...
 */
int push_stack(stack_ts *stack, const void *data);
 ...
 * -1 -> the function failed.
 */
int pop_stack(stack_ts *stack, void *data);
 ...
 * -1 -> the function failed.
 */
int stack_peek(const stack_ts *stack, void *data);
 ...
 */
int stack_is_empty(const stack_ts *stack);
